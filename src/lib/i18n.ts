...
const translations = {
  en: {
    ...
    about: {
      ...
      bio2: "I worked at <strong>BM Services</strong> until <strong>June 2026</strong>, developing and maintaining production e-commerce platforms using <strong>Symfony</strong>. I started there as an intern during my studies, continued through an apprenticeship, and stayed full-time after graduating. This gave me strong real-world experience shipping and maintaining software, not just building demos.",
      ...
      bio4: "I'm currently <strong>looking for a new role</strong> and remain open to exciting projects. If you'd like to work together, feel free to",
      bio4Link: "reach out!",
      ...
      education: "Education",
      jobs: [
        "<strong>BM Services</strong> - Full-Stack Developer (September 2024 - June 2026)",
  ...
  fr: {
    ...
    about: {
      ...
      bio2: "J'ai travaillé chez <strong>BM Services</strong> jusqu'en <strong>juin 2026</strong>, où j'ai développé et maintenu des plateformes e-commerce en production avec <strong>Symfony</strong>. J'y ai commencé comme stagiaire pendant mes études, puis en alternance, avant de rejoindre l'équipe à temps plein après mon diplôme. Cette expérience m'a forgé une solide pratique du développement en conditions réelles.",
      ...
      bio4: "Je suis actuellement <strong>à la recherche d'un emploi</strong> et reste ouvert aux projets stimulants. Si vous souhaitez collaborer, n'hésitez pas à",
      ...
      education: "Formation",
      jobs: [
        "<strong>BM Services</strong> - Développeur Full-Stack (Septembre 2024 - Juin 2026)",
